...
def load_config(args):
    ...
    if args.eval != -1:
        ...
        # path = f'./configs/eval_mamba_inference.json'
        path = f'./configs/eval_mamba_ar.json'
    else:
        # path = './configs/finetune_ssm_config.json'
        # path = './configs/train_mamba_inference.json'
        path = './configs/train_mamba_ar.json'
    ...
    if args.model != 'None':
        json_data['model_type'] = args.model
    
    if args.seed != 'None':
        json_data['seed'] = args.seed
